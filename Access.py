...
# Set icon
st.set_page_config(page_title="MySlack", page_icon="🔐")
...
# Manage session state informations ========================
if 'logged_in' not in st.session_state:
    st.session_state['logged_in'] = [False, False, "not_set"]
        ...
        if enter:
            ...
            for  doc in docs:
                ...
                if username == doc_dict["username"] and password == doc_dict["password"]:
                    ...
                    st.session_state.logged_in[2] = username
...
if(not st.session_state.logged_in[0]):
    ...
    st.subheader("To sign in again press CTRL+R")
